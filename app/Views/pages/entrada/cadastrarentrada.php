...
<div class="container">
    ...
    <h2 class="mt-3">Entrada de Produtos</h2>
    <div class="card">
        <div class="card-body">
            <form action="<?php echo BASE_URL ?>entrada/salvardados" method="POST">
                <div class="row">
                    ...
                    <div class="form-floating col-md-3">
                        ...
                        <label for="floatingInput">Data da Entrada</label>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="form-floating col-md-4">
                        <input type="text" class="form-control" id="minimo" name="minimo" placeholder="Quantidade mínima">
                        <label for="floatingPassword">Mínimo</label>
                    </div>

                    <div class="form-floating col-md-4">
                        <input type="text" class="form-control" id="maximo" name="maximo" placeholder="Bairro">
                        <label for="floatingPassword">Máximo</label>
                        <div>
                        </div>
                    </div>
